...
public class FoundationTableTest {
    ...
    public void invalidOperations(){
        ...
        //Act and assert
        assertEquals(null,ft.get(0));
        assertEquals(false,ft.verify());
        assertEquals(false,ft.insert(0, D2));
        assertEquals(true,ft.insert(1, D1));
        assertEquals(false,ft.insert(0, D2));
        assertEquals(false,ft.insert(1, H2));
        assertEquals(true,ft.insert(1, D2));
        assertEquals(false,ft.insert(0, H2));
        assertEquals(true,ft.insert(0, H1));
        assertEquals(true,ft.insert(0, H2));
        assertEquals(true,ft.insert(0, H3));
        assertEquals(true,ft.insert(1, D3));
        assertEquals(false, ft.verify());
        assertEquals(H3, ft.get(0));
        assertEquals(H2, ft.get(0));
        assertEquals(H1, ft.get(0));
        assertEquals(true,ft.insert(2, H1));
