...
public class StockTable {
    ...
    public Card getCard(){ return  stacks[waste].pop(); }
    public Card peek(){ return stacks[waste].peek(); }

    public boolean isEmpty(){ return stacks[talon].isEmpty() && stacks[waste].isEmpty();}
